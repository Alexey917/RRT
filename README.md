...
| Обычный вывод | Пагинация |
|:---:|:---:|
| ![Обычный](./screenshots/1.png) | ![Пагинация](./screenshots/2.png) |

| Бесконечный скролл (начало) | Бесконечный скролл (прокрутка) |
|:---:|:---:|
...
|:---:|:---:|
| ![Кастомный селект 1](./screenshots/5.png) | ![Кастомный селект 2](./screenshots/9.png) |

### React Select

| Одиночный выбор | Множественный выбор |
|:---:|:---:|
| ![React Select 1](./screenshots/7.png) | ![React Select 2](./screenshots/8.png) |

### Фильтрация и сортировка

| Результат |
|:---:|
| ![Фильтрация](./screenshots/6.png) |
